...
export const createNewCategory = async (request, reply) => {
...
export const updateExistingCategory = async (request, reply) => {
...
export const deleteExistingCategory = async (request, reply) => {
    const { id } = request.params;
