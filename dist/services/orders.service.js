...
export async function getOrderById(id, requestingUserId, isAdmin) {
...
export async function updateOrder(id, data, requestingUserId, isAdmin) {
...
export async function cancelOrder(id, requestingUserId, isAdmin) {
    // Verificar se pedido existe
    const existingOrder = await prisma.order.findUnique({
        where: { id },
    });
